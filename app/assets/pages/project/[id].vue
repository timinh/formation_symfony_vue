...
<template>
    <div v-if="store.currentProject" class="q-ma-md">
        <div class="row items-center justify-between">
            ...
            <q-space />
            <q-btn class="q-mr-sm" v-if="userStore.roles.includes('ROLE_ADMIN')" :disabled="isPrinting" :loading="isPrinting" icon="print" round color="primary" @click="printProjectTasks" />
